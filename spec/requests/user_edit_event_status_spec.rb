...
describe 'Usuário altera status do buffet' do
  context "para inativo" do
    it "e não está autenticado" do
      ...
      e = Event.create!(name: 'Festa de Aniversário', description: '...', duration: 240, menu: '...', 
                        minimum_guests_number: 50, maximum_guests_number: 120, venue: v, status: :active)
  
      # Act
      post(inactive_event_path(e.id))
    ...
    it "e não é o responsável" do
      ...
      event = Event.create!(name: 'Festa de Aniversário', description: '...', duration: 240, menu: '...', 
                            minimum_guests_number: 50, maximum_guests_number: 120, venue: first_venue, status: :active)
      # Act
  ...
  context "para ativo" do
    it "e não está autenticado" do
      ...
      v = Venue.create!(brand_name: "Meu Buffet", corporate_name: "Buffet & Eventos Ltda", registration_number:"66.666.666/0001-00",
                        ...
                        payment_methods: "", user: u, status: :active)
      e = Event.create!(name: 'Festa de Aniversário', description: '...', duration: 240, menu: '...', 
                        minimum_guests_number: 50, maximum_guests_number: 120, venue: v, status: :inactive)
  
      # Act
      post(active_event_path(e.id))
    ...
    it "e não é o responsável" do
      ...
      second_venue = Venue.create!(brand_name: "Buffet São Paulo", corporate_name: "Segundo Buffet SA",  description: "...",
                                  ...
                                  email: "eventos@second.com", phone_number: "(31)99220-9292", user: second_user, status: :active)
      event = Event.create!(name: 'Festa de Aniversário', description: '...', duration: 240, menu: '...', 
                            minimum_guests_number: 50, maximum_guests_number: 120, venue: first_venue, status: :inactive)
      # Act
      login_as(second_user, scope: :user)
